...
// $conn=new PDO("mysql:host=localhost;dbname=kaashiv",'root','');
// if(isset($_POST["submit"]))
// {
//     $str=$_POST["search"];
//     $sth=$con->prepare("SELECT * FROM tbl_country WHERE cname='$name'");
...
<input type="button" name="search" value="Search" class="btn-success">
</div>
</form> 
